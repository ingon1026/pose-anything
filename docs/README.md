...
| 문서 | 요지 |
|---|---|
| [image_size_2026-08-21.md](image_size_2026-08-21.md) | 672 의 대가 셋 — 소물체 소실 / 치수 −18% / 그러나 속도는 우세 |
...
| `image_size` 672 vs 1008 | 속도(4.60 vs 2.70 Hz) ↔ 치수 정확도(−18% vs +0.7mm) 정면 충돌 | [image_size](image_size_2026-08-21.md) ③④ |
...
- **수치를 인용할 때 조건을 같이 적을 것.** 같은 양이 조건에 따라 크게 다르다:
  ...
  - 치수 정확도 — "정답 +0.7mm" 는 **1008 기준**, 672 에서는 −10.5mm
